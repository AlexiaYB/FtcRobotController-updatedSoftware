...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1925.5853628184595; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2039.504340570316; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 2354.874949832734; // x position of the perpendicular encoder (in tick units)
    }
